        ...
        <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
            <div class="panel heading-border">
                <form:form id="admin-form" name="addForm" action="/claim_voucher/update" modelAttribute="info">
                    <form:input path="claimVoucher.id" type="hidden"/>
                            ...
                            <div>
                                ...
                                <div class="col-md-3">
                                    <label for="items[${sta.index}].amount" class="field prepend-icon">
                                        <form:input path="items[${sta.index}].amount" class="gui-input money" placeholder="金额..."/>
                                ...
                                <div class="col-md-5">
                                    <label for="items[${sta.index}].comment" class="field prepend-icon">
                                        <form:input path="items[${sta.index}].comment" class="gui-input" placeholder="备注..."/>
                        ...
                        <div class="section row">
                            <div class="col-md-3">
                                <label for="totalMoney" class="field prepend-icon">
                                    <form:input id="totalMoney" path="claimVoucher.totalCount" class="gui-input" placeholder="总金额..." readonly="true"/>
