...
<%@ page import="com.yuan.oa.global.contant" %>
            ...
            <div class="panel heading-border">
                <div class="panel-body bg-light">
                    ...
                    <div class="section row">
                        ...
                        <div class="col-md-4">${claimVoucher.nextDealSn}</div>
                    ...
                    <div class="section row">
                        ...
                        <div class="col-md-6">${claimVoucher.totalCount}</div>
                    </div>
                    <div class="section-divider mt20 mb40">
                        <span> 处理流程 </span>
                    </div>
                    ...
                    <form:form id="admin-form" name="addForm" action="/claim_voucher/check" method="post" modelAttribute="record">
